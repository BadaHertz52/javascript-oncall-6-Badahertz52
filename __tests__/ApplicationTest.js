...
test(" 주말로 시작하며 일 수가 30일인 달에 대한 기능 테스트", async () => {
  await run({
    inputs: [
      "4,토",
      "허브,쥬니,말랑,라온,헤나,우코,에단,수달,파워,히이로,마코,슬링키,모디,연어,깃짱,리오,고니,박스터,달리,조이,노아이즈,도이,도치,홍고,스캇,폴로,해시,로지,첵스,아이크,우가,푸만능,애쉬,로이스,오션",
...
test("평일로 시작하며 일 수가 31일인 달에 대한 기능 테스트", async () => {
  await run({
    inputs: [
      "5,화",
      "허브,쥬니,말랑,라온,헤나,우코,에단,수달,파워,히이로,마코,슬링키,모디,연어,깃짱,리오,고니,박스터,달리,조이,노아이즈,도이,도치,홍고,스캇,폴로,해시,로지,첵스,아이크,우가,푸만능,애쉬,로이스,오션",
    ...
    expected: [
      "5월 1일 화 허브" + LINE_SEPARATOR,
      "5월 2일 수 쥬니" + LINE_SEPARATOR,
      "5월 3일 목 말랑" + LINE_SEPARATOR,
      "5월 4일 금 라온" + LINE_SEPARATOR,
      "5월 5일 토 오션" + LINE_SEPARATOR,
      "5월 6일 일 로이스" + LINE_SEPARATOR,
      "5월 7일 월 헤나" + LINE_SEPARATOR,
      "5월 8일 화 우코" + LINE_SEPARATOR,
      "5월 31일 목 도치",
    ],
  });
});

test(" 평일인 법정 휴일이 있는 달에 대한 기능 테스트", async () => {
  await run({
    inputs: [
      "6,토",
      "허브,쥬니,말랑,라온,헤나,우코,에단,수달,파워,히이로,마코,슬링키,모디,연어,깃짱,리오,고니,박스터,달리,조이,노아이즈,도이,도치,홍고,스캇,폴로,해시,로지,첵스,아이크,우가,푸만능,애쉬,로이스,오션",
    ...
    expected: [
      "6월 1일 토 오션" + LINE_SEPARATOR,
      "6월 2일 일 로이스" + LINE_SEPARATOR,
      "6월 3일 월 허브" + LINE_SEPARATOR,
      "6월 4일 화 쥬니" + LINE_SEPARATOR,
      "6월 5일 수 말랑" + LINE_SEPARATOR,
      "6월 6일 목(휴일) 애쉬" + LINE_SEPARATOR,
      "6월 7일 금 라온" + LINE_SEPARATOR,
      "6월 8일 토 푸만능" + LINE_SEPARATOR,
      "6월 9일 일 우가" + LINE_SEPARATOR,
      "6월 10일 월 헤나" + LINE_SEPARATOR,
      "6월 11일 화 우코" + LINE_SEPARATOR,
    ],
  });
});
